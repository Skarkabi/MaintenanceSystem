...
--
-- Table structure for table `other_stocks`
--

DROP TABLE IF EXISTS `other_stocks`;
...
CREATE TABLE `other_stocks` (
  ...
  PRIMARY KEY (`id`),
  KEY `other_id_index` (`id`),
  KEY `other_other_name_index` (`other_name`),
  KEY `other_quantity_index` (`quantity`),
  KEY `other_singleCost_index` (`singleCost`),
  KEY `other_totalCost_index` (`totalCost`),
  KEY `other_details_index` (`details`),
  KEY `other_createdAt_index` (`createdAt`),
  KEY `other_updatedAt_index` (`updatedAt`),
...
--
-- Dumping data for table `other_stocks`
--
